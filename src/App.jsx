      ...
      <main>
        <section className="hero" id="inicio">
          <div className="hero-content">
            <div className="hero-copy"><p className="eyebrow">Clases de Brazilian Jiu-Jitsu · Chile</p><h1>Entrena con <em>proposito.</em></h1><p className="hero-lead">Clases de BJJ para hombres y mujeres que quieren aprender, fortalecerse y descubrir todo lo que pueden hacer con tecnica y constancia.</p><div className="button-row"><a className="button button-primary" href={whatsappLink('Hola, quiero agendar mi clase de prueba de BJJ.')} target="_blank" rel="noreferrer">Agendar clase de prueba <span>↗</span></a><a className="button button-outline" href="#clases">Conocer las clases</a></div><div className="hero-stats"><div><strong>10+</strong><span>Anos entrenando</span></div><div><strong>100%</strong><span>Atencion cercana</span></div><div><strong>∞</strong><span>Ganas de aprender</span></div></div></div>
            <div className="hero-visual"><div className="image-frame"><img src="/images/pamela-bjj-hero.png" alt="Pamela Vargas Milla practicando Brazilian Jiu-Jitsu" width="1200" height="1600" fetchPriority="high" /></div><div className="credential-card"><span className="credential-line"></span><div><strong>PROFESORA</strong><span>Pamela Vargas Milla</span></div><b>FAIXA<br />PRETA <small>2º GRAU</small></b></div><span className="hero-stamp">DISCIPLINA<br /><i>+ MOVIMIENTO</i></span></div>
          </div>
          <div className="hero-details"><div><span className="detail-icon">◌</span><div><small>PARA TODOS</small><strong>Hombres y mujeres</strong></div></div><div><span className="detail-icon">◈</span><div><small>NIVEL</small><strong>Desde cero a avanzado</strong></div></div><div><span className="detail-icon">↗</span><div><small>PRIMER PASO</small><strong>Agenda tu clase de prueba</strong></div></div></div>
