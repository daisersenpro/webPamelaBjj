...
function App() {
  ...
  const [contactForm, setContactForm] = useState({ name: '', phone: '', email: '', reason: '', otherReason: '', query: '' })
  ...
  return (
    <div className="site-shell">
      <header className="site-header">
        ...
        <nav className="desktop-nav" aria-label="Navegacion principal"><a href="#sobre-mi">Sobre mi</a><a href="#clases">Clases</a><a href="#cinturones">Cinturones</a><a href="#contacto">Contacto</a></nav>
      ...
      <main>
        <section className="hero" id="inicio">
          <div className="hero-content">
            <div className="hero-copy"><p className="eyebrow">Brazilian Jiu-Jitsu · Santiago</p><h1>Entrena con <em>proposito.</em></h1><p className="hero-lead">Un espacio para aprender, fortalecerte y descubrir todo lo que puedes hacer con tecnica y constancia.</p><div className="button-row"><a className="button button-primary" href={whatsappLink('Hola, quiero agendar mi clase de prueba de BJJ.')} target="_blank" rel="noreferrer">Agendar clase de prueba <span>↗</span></a><a className="button button-outline" href="#clases">Conocer las clases</a></div><div className="hero-stats"><div><strong>10+</strong><span>Anos entrenando</span></div><div><strong>100%</strong><span>Atencion cercana</span></div><div><strong>∞</strong><span>Ganas de aprender</span></div></div></div>
            <div className="hero-visual"><div className="image-frame"><img src="https://images.pexels.com/photos/38678599/pexels-photo-38678599.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Dos mujeres entrenando Brazilian Jiu-Jitsu sobre el tatami" /></div><div className="credential-card"><span className="credential-line"></span><div><strong>PROFESORA</strong><span>Pamela BJJ</span></div><b>FAIXA<br />PRETA <small>2º GRAU</small></b></div><span className="hero-stamp">DISCIPLINA<br /><i>+ MOVIMIENTO</i></span></div>
          </div>
