      ...
      <main>
        <section className="hero" id="inicio">
          <div className="hero-content">
            ...
            <div className="hero-visual"><div className="image-frame"><img src="https://i.ibb.co/x8sT1XK9/Principal-Imagen-Web-Pame-bjj.png" alt="Pamela practicando Brazilian Jiu-Jitsu" /></div><div className="credential-card"><span className="credential-line"></span><div><strong>PROFESORA</strong><span>Pamela BJJ</span></div><b>FAIXA<br />PRETA <small>2º GRAU</small></b></div><span className="hero-stamp">DISCIPLINA<br /><i>+ MOVIMIENTO</i></span></div>
          </div>
