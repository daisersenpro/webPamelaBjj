      ...
      <main>
        <section className="hero" id="inicio">
          <div className="hero-content">
            ...
            <div className="hero-visual"><div className="image-frame"><img src="https://images.pexels.com/photos/7045747/pexels-photo-7045747.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Entrenamiento de Brazilian Jiu-Jitsu en el tatami" /></div><div className="credential-card"><span className="credential-line"></span><div><strong>PROFESORA</strong><span>Pamela BJJ</span></div><b>FAIXA<br />PRETA <small>2º GRAU</small></b></div><span className="hero-stamp">DISCIPLINA<br /><i>+ MOVIMIENTO</i></span></div>
          </div>
