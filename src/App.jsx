      ...
      <main>
        <section className="hero" id="inicio">
          <div className="hero-content">
            ...
            <div className="hero-visual"><div className="image-frame"><img src="https://images.unsplash.com/photo-1555597673-b21d5c935865?auto=format&fit=crop&w=1200&q=85" alt="Entrenamiento de jiu-jitsu en el tatami" /></div><div className="credential-card"><span className="credential-line"></span><div><strong>PROFESORA</strong><span>Pamela BJJ</span></div><b>FAIXA<br />PRETA <small>2º GRAU</small></b></div><span className="hero-stamp">DISCIPLINA<br /><i>+ MOVIMIENTO</i></span></div>
          </div>
