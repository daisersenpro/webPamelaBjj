  ...
  return (
    <div className="site-shell">
      <header className="site-header">
        ...
        <nav className="desktop-nav" aria-label="Navegacion principal"><a href="#sobre-mi">Sobre mi</a><a href="#historia">Historia</a><a href="#clases">Clases</a><a href="#cinturones">Cinturones</a><a href="#contacto">Contacto</a></nav>
